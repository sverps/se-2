...
export const ContractData = () => {
  ...
  useScaffoldContractRead("YourContract", "testRead", { args: [] });
  useScaffoldContractRead("YourContract", "testRead", { args: [BigNumber.from(1), "2"] });
  useScaffoldContractRead("YourContract", "testRead", { args: [BigNumber.from(1)] });
  useScaffoldContractRead("YourContract", "testRead", { args: [BigNumber.from(1)], address: "123" });
  useScaffoldContractRead("YourContract", "totalCounter", { args: [BigNumber.from(1)] });
  ...
  useScaffoldContractWrite("YourContract", "setGreeting", { value: "1" });
  useScaffoldContractWrite("YourContract", "setGreeting", { args: ["new greeting", "wrong string"] });
  useScaffoldContractWrite("YourContract", "setGreeting", { args: ["new greeting"], address: "123" });
  useScaffoldContractWrite("YourContract", "setGreeting", {
    args: ["new greeting"],
    value: "1",
    address: "123",
